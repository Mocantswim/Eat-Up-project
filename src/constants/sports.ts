...
const EXERCISE_TYPES: ExerciseTypeDef[] = [
  ...
  { typeName: '游泳', emoji: '🏊', groupId: 'cardio', kind: 'duration', modes: ['duration', 'distance'], met: 6.0, distanceFactor: 3.0, aliases: '泳',
    variants: [
      ...
      { name: '水中跑步', met: 5.0, distanceFactor: 2.0 },
      { name: '水中踢腿', met: 5.0, distanceFactor: 2.0 },
      { name: '仰泳打腿', met: 4.0, distanceFactor: 1.8 },
      { name: '自由泳打腿', met: 5.0, distanceFactor: 2.0 },
      { name: '蝶泳打腿', met: 6.0, distanceFactor: 2.5 },
    ] },
  ...
  { typeName: '跳绳', emoji: '🤸', groupId: 'cardio', kind: 'duration', modes: ['duration', 'reps'], met: 8.0, repFactor: 0.01, aliases: '绳',
    variants: [
      ...
      { name: '跑步跳', met: 8.0, repFactor: 0.012 },
      { name: '后踢腿跳', met: 9.0, repFactor: 0.015 },
      { name: '高抬腿跳', met: 10.0, repFactor: 0.018 },
      { name: '单脚交替跳', met: 9.0, repFactor: 0.015 },
      { name: '绳操', met: 7.0, repFactor: 0.01 },
    ] },
